...
import SupportGroupStepper from "../Stepper/supportGroupStepper";

export default function SupportGroupsCardButton({ title,onSuccess }) {
  ...
  return (
    <>
      ...
      >
        ...
        <SupportGroupStepper onSuccess={handleSuccess}/>
      </Modal>
